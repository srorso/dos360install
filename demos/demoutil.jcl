// JOB DEMOUTIL CDTP-SORT-TPPR
// RESET SYS000
// UPSI 00000000
// ASSGN SYS004,X'00C' INPUT
// ASSGN SYS005,X'280' OUTPUT
// TLBL UOUT,'PEOPLE'
// EXEC CDTP
// UCT TRF,FF,A=(80,80),B=(39,390),OR
// FS 1,32,1/33,(P,7,4),33
// END
...
/*
// ASSGN SYS001,X'280' OUTPUT
// ASSGN SYS002,X'280' INPUT
// TLBL SORTOUT,'PEOPLE'
// TLBL SORTIN1,'PEOPLE'
// LBLTYP TAPE
// EXEC SORT
 SORT WORK=1,FILES=1,FORMAT=BI,FIELDS=(2,3,A)
 RECORD TYPE=F,LENGTH=39
 INPFIL BLKSIZE=390
 OUTFIL BLKSIZE=390
 OPTION PRINT=ALL,LABEL=(S,S)
 END
/*
// ASSGN SYS004,X'280' INPUT
// ASSGN SYS005,X'00E' OUTPUT
// TLBL UIN,'PEOPLE' 
// EXEC TPPR
// UTP TLF,FF,A=(39,390),B=(120),IR,OC,S1,PY   
// FS 1,2,2/3,3,6/6,20,11/33,(U,4,7),41
