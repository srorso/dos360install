...
// EXEC ASSEMBLY
         ...
         SPACE 2
         ALLOC F1=510K,                 SIZE OF F1  (MAX IS 510K)      X
               F2=510K                  SIZE OF F2  (MAX IS 510K)
         SPACE 2
         IOTAB BGPGR=32,                MAX BG SYSXXX ASSGN'S          X
               F1PGR=32,                MAX F1 SYSXXX ASSGN'S          X
               F2PGR=32,                MAX F2 SYSXXX ASSGN'S          X
               IODEV=48,                NUMBER OF DEVICES SUPPORTED    X
               JIB=128,                 NUM OF JOB INFORMATION BLOCKS  X
               CHANQ=32                 NUM OF CHANNEL QUEUE ENTRIES    
         SPACE 2
...
* F2 PARTITION UNIT RECORD
         ...
         SPACE 2
* DISPLAY DEVICES
         DVCGEN CHUN=X'0A0',DVCTYP=3277
         DVCGEN CHUN=X'0A1',DVCTYP=3277
         DVCGEN CHUN=X'0A2',DVCTYP=3277
         DVCGEN CHUN=X'0A3',DVCTYP=3277
         DVCGEN CHUN=X'0A4',DVCTYP=3277
         DVCGEN CHUN=X'0A5',DVCTYP=3277,MODE=X'01'
         SPACE 2
